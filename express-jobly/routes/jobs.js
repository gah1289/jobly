...
/** POST / { job } =>  { job }
 *
 * job should be {id, title, salary, equity, company_handle AS "companyHandle"}
 *
...
/** GET /[id]  =>  { job }
 *
 *  Job is { id, title, salary, equity, company_handle AS "companyHandle" }
 *   where jobs is [{ od, title, salary, equity, company_handle AS "companyHandle" }, ...]
 *
 * Authorization required: none
 */
